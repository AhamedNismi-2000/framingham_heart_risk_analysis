...
-- Load Table in the Database
    ...
    COPY framingham_cleaned (gender, age, education_level, is_smoker, cigarettes_per_day,
        on_bp_medication, had_stroke, has_hypertension, has_diabetes, total_cholesterol,
        systolic_bp, diastolic_bp, bmi, heart_rate, glucose_level, chd_risk_10yr, has_outlier_flag)
